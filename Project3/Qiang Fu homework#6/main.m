warning('off');
read_data;
%The first part is for the seq1
points = [];
optical_flows = [];
windowsize_c = 5;
windowsize_r = 5;
...
for c = 1+(windowsize_c-1)/2:5:200-(windowsize_c-1)/2
    for r = 1+(windowsize_r-1)/2:5:200-(windowsize_r-1)/2
        [Optical_flow,flag] = TheSecondMethod(c,r,t,windowsize_c,windowsize_r,windowsize_t,seq_1,threshold);
